...
void loop()
{
    Serial.println((ultrasonic_distance_9_10( )));
    delay(100);
    if (ultrasonic_distance_9_10( ) < 5) 
    {
      do
      {
        colorled13(1,"#cc33cc");
        ...
        while((ultrasonic_distance_9_10( ) < 5));
    } 
    else if (ultrasonic_distance_9_10( ) < 10) 
    {
      colorled13(1,"#ff0000");
      colorled13(2,"#ff0000");
    }
    else if (ultrasonic_distance_9_10( ) < 15) 
    {
      colorled13(1,"#ffff00");
      colorled13(2,"#ffff00");
    } else {
